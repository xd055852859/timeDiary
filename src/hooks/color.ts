...
export const lightColors = [
  ...
  { name: "--el-dialog-bg-color", value: "#fff" },

  { name: "--diary-font-color", value: "#333" },
  { name: "--diary-bg-color", value: "#fff" },
  { name: "--diary-diary-color", value: "#f1f1f1" },
...
export const darkColors = [
  ...
  // { name: "--el-color-white", value: "#333" },
  { name: "--el-color-primary", value: "#484848" },
  { name: "--el-dialog-bg-color", value: "#373A48" },

  { name: "--diary-font-color", value: "#fff" },
  { name: "--diary-bg-color", value: "#373a48" },
  { name: "--diary-diary-color", value: "#373a48" },
